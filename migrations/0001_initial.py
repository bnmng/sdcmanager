# Generated by Django 2.1.1 on 2018-09-04 13:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voting_address', models.TextField(blank=True, help_text="What is this person's voting address?", max_length=1000, verbose_name='Voting Address')),
                ('mailing_address', models.TextField(blank=True, help_text="What is this person's mailing address?", max_length=1000, verbose_name='Mailing Address')),
                ...
                ('membershiptype', models.ForeignKey(blank=True, help_text="What is the type of this person's membership?", null=True, on_delete=django.db.models.deletion.PROTECT, to='sdcpeople.MembershipType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('district', models.ForeignKey(help_text='What is the district in which the person lives?', on_delete=django.db.models.deletion.CASCADE, to='sdcpeople.District')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.CharField(help_text="What is this person's voice phone number. It can include additional info like extensions?", max_length=30, verbose_name='Number')),
                ...
                ('notes', models.CharField(blank=True, help_text='What are notes about this phone (ex "Ask for Sarg", "Don\'t call before noon")? ', max_length=255, verbose_name='Notes')),
